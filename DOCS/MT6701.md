...
When programming the board be sure to do it at +5V over I2C. Suppose you bought a MT6701 board and you wanted to determine its mode setting. Use this with a arduino-based controller:
```
#include <Wire.h>
