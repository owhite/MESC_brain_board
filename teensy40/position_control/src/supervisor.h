...
enum SupervisorMode {
  ...
  SUP_MODE_TEST_CAN,
  SUP_MODE_TIMED_POS_CONTROL,
  SUP_MODE_PWM_POS_CONTROL,
...
struct Supervisor_typedef {
  ...
  uint32_t user_test_can_total_us = 1000;
  uint32_t user_timed_pos_total_us = 1000;
  int32_t user_timed_pos_sweep_deg = 0;
